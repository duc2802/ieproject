...
public class IndividualPropertiesDialog extends JDialog {
	...
	public IndividualPropertiesDialog() {
		initComponents();
	}

	public IndividualPropertiesDialog(JFrame mainFrame, String nameMyIndividual) {
		super(mainFrame);
	...
	public IndividualPropertiesDialog(JFrame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	}

	public IndividualPropertiesDialog(JFrame parent, String title, boolean modal) {
		super(parent, title, modal);
		initComponents();
	}

	public IndividualPropertiesDialog(JFrame parent, String title,
			boolean modal, GraphicsConfiguration arg) {
		super(parent, title, modal, arg);
		initComponents();
	}

	public IndividualPropertiesDialog(Dialog parent) {
		super(parent);
		initComponents();
	}

	public IndividualPropertiesDialog(Dialog parent, boolean modal) {
		super(parent, modal);
		initComponents();
	}

	public IndividualPropertiesDialog(Dialog parent, String title) {
		super(parent, title);
		initComponents();
	}

	public IndividualPropertiesDialog(Dialog parent, String title, boolean modal) {
		super(parent, title, modal);
		initComponents();
	}
	...
	public IndividualPropertiesDialog(Window parent) {
		super(parent);
		initComponents();
	}

	public IndividualPropertiesDialog(Window parent, ModalityType modalityType) {
		super(parent, modalityType);
		initComponents();
	}

	public IndividualPropertiesDialog(Window parent, String title) {
		super(parent, title);
		initComponents();
	}
